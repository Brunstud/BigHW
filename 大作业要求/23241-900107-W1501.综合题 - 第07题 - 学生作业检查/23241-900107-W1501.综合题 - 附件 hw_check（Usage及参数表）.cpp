...
int main(int argc, char** argv)
{
	...
	args_analyse_tools args[] = {
		...
		st_args_analyse("--action",   ST_EXTARGS_TYPE::str_with_set_error, 1, -1, Action_Name),	//参数-1无意义，表示无默认，必须指定
		st_args_analyse("--cno",      ST_EXTARGS_TYPE::str,                1, string("")),
		st_args_analyse("--stu",      ST_EXTARGS_TYPE::str,                1, string("")),
		st_args_analyse("--file",     ST_EXTARGS_TYPE::str,                1, string("")),
		st_args_analyse("--chapter",  ST_EXTARGS_TYPE::int_with_error,     1, -1, -1, 99), //参数-1表示不进行章节选择
		st_args_analyse("--week",     ST_EXTARGS_TYPE::int_with_error,     1, -1, -1, 20), //参数-1表示不进行周次选择
		st_args_analyse("--display",  ST_EXTARGS_TYPE::str,                1, string("11111")),
		st_args_analyse("--cfgfile",  ST_EXTARGS_TYPE::str,                1, string("hw_check.conf")),
