...
int main(int argc, char** argv)
{
	...
	st_args_analyse args[] = {
		...
		st_args_analyse("--debug",			ST_EXTARGS_TYPE::boolean, 0, false),
		st_args_analyse("--file1",			ST_EXTARGS_TYPE::str, 1, string("")),
		st_args_analyse("--file2",			ST_EXTARGS_TYPE::str, 1, string("")),
		st_args_analyse("--trim",				ST_EXTARGS_TYPE::str_with_set_error, 1, 0, TrimType),
		st_args_analyse("--lineskip",			ST_EXTARGS_TYPE::int_with_default,   1, 0, 0, 100),
		st_args_analyse("--lineoffset",		ST_EXTARGS_TYPE::int_with_default,   1, 0, -100, 100),
		st_args_analyse("--ignore_blank",		ST_EXTARGS_TYPE::boolean, 0, false),
		st_args_analyse("--CR_CRLF_not_equal",	ST_EXTARGS_TYPE::boolean, 0, false),
		st_args_analyse("--max_diff",			ST_EXTARGS_TYPE::int_with_default,   1, 0, 0, 100),
		st_args_analyse("--max_line",			ST_EXTARGS_TYPE::int_with_default,   1, 0, 0, 10000),
		st_args_analyse("--display",			ST_EXTARGS_TYPE::str_with_set_error, 1, 0, DisplayType),
		st_args_analyse()  //最后一个，用于结束
	};
	int cur_argc, ret = 0;
