...
int main(int argc, char **argv)
{
	...
	st_args_analyse args[] = {
		...
		st_args_analyse("--cfgfile",    ST_EXTARGS_TYPE::str,                  1, string("")),		//必须加string()，否则被适配到args_analyse(const char *arg_name, enum ST_EXTARGS_TYPE type, int ext_num, bool def)
